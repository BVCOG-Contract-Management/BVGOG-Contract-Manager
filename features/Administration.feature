...
Scenario: Update contract document storage
  ...
  And I fill in "bvcog_config[contracts_path]" with "/home/liam/Documents/CSCE_606/BVGOG-Contract-Manager/public/contracts"
  And I press "commit"
  Then I should see "Configuration was successfully updated."

Scenario: Fail to update contract document storage
  Given I am on the admin page
  And I fill in "bvcog_config[contracts_path]" with "/home/liam/Documents/CSCE_606/BVGOG-Contract-Manager/public/does_not_exist"
  And I press "commit"
  Then I should see "Contracts path is invalid."

Scenario: Update contract reports storage
  Given I am on the admin page
  And I fill in "bvcog_config[reports_path]" with "/home/liam/Documents/CSCE_606/BVGOG-Contract-Manager/public/reports"
  And I press "commit"
  Then I should see "Configuration was successfully updated."

Scenario: Fail to update contract reports storage
  Given I am on the admin page
  And I fill in "bvcog_config[reports_path]" with "/home/liam/Documents/CSCE_606/BVGOG-Contract-Manager/public/does_not_exist"
  And I press "commit"
