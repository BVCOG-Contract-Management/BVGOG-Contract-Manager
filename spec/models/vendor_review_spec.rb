...
RSpec.describe VendorReview, type: :model do
  ...
  it "should not save vendor review without vendor" do
  ...
  it "should not save vendor review with invalid rating" do
  ...
  it "should not save vendor review with duplicate user-vendor pair" do
